...
public class JHS_examInfoController implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        btn_UpdateResult.setOnAction(event -> {
            ...
            jhs_examEntryController.populateForm(resultTable.getSelectionModel().getSelectedItem());
            jhs_examEntryController.btn_Add.setVisible(false);
            jhs_examEntryController.btn_Save.setVisible(true);
    ...
    private void deleteExamResult(ExamRecordData exam_record) throws SQLException {
      ...
      /*  try {
            ...
            pr = conn.prepareStatement("DELETE FROM jhsSubjectTable WHERE jhsSubjectTable.Record_id = '" + id + "'");
            pr.execute();
